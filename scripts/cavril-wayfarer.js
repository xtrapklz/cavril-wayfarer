...
const Camp = (() => {
    ...
    async function resolveNight() {
        ...
        body += cwfRow("Danger", `Danger ${cwfThreat(cls)} · Heat ${cwfHeat(cls)} (×2 at night) · one roll / 2h`);
...
Hooks.once("ready", () => {
    ...
    globalThis.CavrilWayfarer = {
        ...
        Domain, Store, Canvasry, Augur, HexData, Hex, Travel, CourseOverlay, Turn, Tables, Party, MiniCal, Music, Danger, Camp, Cinematic, TravelingMerchants, _installed: true
    };
